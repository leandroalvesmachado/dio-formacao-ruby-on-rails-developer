# Desafio
# Você é um desenvolvedor em início de carreira e foi contratado por um banco para criar um sistema básico 
# de abertura de contas. Sua tarefa é implementar uma classe chamada "ContaBancaria" que represente uma 
# conta bancária com as seguintes informações: número da conta, nome do titular e saldo.
